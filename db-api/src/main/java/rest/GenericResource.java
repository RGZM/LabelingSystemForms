...
public class GenericResource {
	...
	@GET
	@Path("/objects")
	public Response getObjects(@HeaderParam("Accept") String acceptHeader) throws IOException, JDOMException, ParserConfigurationException, TransformerException {
		try {
			JSONArray objects = SQLite.getObjects();
    ...
    @GET
	@Path("/objects/{id}")
	public Response getObject(@HeaderParam("Accept") String acceptHeader, @PathParam("id") String itemID) throws IOException, JDOMException, ParserConfigurationException, TransformerException {
		try {
    ...
    @GET
	@Path("/locations/{id}")
	public Response getLocation(@HeaderParam("Accept") String acceptHeader, @PathParam("id") String itemID) throws IOException, JDOMException, ParserConfigurationException, TransformerException {
		try {
    ...
    @GET
	@Path("/potters/{id}")
	public Response getPotter(@HeaderParam("Accept") String acceptHeader, @PathParam("id") String itemID) throws IOException, JDOMException, ParserConfigurationException, TransformerException {
		try {
    ...
    @GET
	@Path("/forms/{id}")
	public Response getForms(@HeaderParam("Accept") String acceptHeader, @PathParam("id") String itemID) throws IOException, JDOMException, ParserConfigurationException, TransformerException {
		try {
